	...
	<footer style="border-top: 4px solid #ff8680;  ">
		<div class="container" style="padding-bottom: 50px;">
			<div class="row">
				<div class="col-md-4">
					<h3 style="color: #ff8680"><b>Tanduran Hannah</b></h3>
					<p>Jl. Bukit Merak no 2A</p>
					<p><i class="glyphicon glyphicon-earphone"></i> +6285385129052</p>
					<p><i class="glyphicon glyphicon-envelope"></i> tanduranhannah@gmail.com</p>
				</div>
				<div class="col-md-4">
					<h5><b>Menu</b></h5>
		...
		<div class="copy" style="background-color: #ff8680; padding: 5px; color: #fff; text-align: center;">
			<span>Copyright&copy; Urlopenda</span>
		</div>
	</footer>
